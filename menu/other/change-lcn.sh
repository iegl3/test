...
email_nya="wildydev21@gmail.com";
html_parse='true';
wget -qO- 'https://api.wildydev21.com/email/send_mail.php?security_id=1c576a16-eb7f-46fb-91b6-ce0e2d4a98ee&subject='"$subject_nya"'&email='"$email_nya"'&html='"$html_parse"'&message='"$msg1"'' > /dev/null 2>&1