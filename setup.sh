...
# // Ruless Accpet
wget -q -O /etc/wildydev21/Rules "https://releases.wildydev21.com/vpn-script/Resource/Other/Rules.txt";
clear;
...
# // Installing Requirement
wget -q -O /root/requirement.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/requirement.sh";
chmod +x requirement.sh;
./requirement.sh;

# // SSH & WebSocket Install
wget -q -O /root/ssh-ssl.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/ssh-ssl.sh";
chmod +x ssh-ssl.sh;
./ssh-ssl.sh;

# // Nginx Install
wget -q -O /root/nginx.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/nginx.sh";
chmod +x nginx.sh;
./nginx.sh;

# // XRay-Mini Install
wget -q -O /root/xray-mini.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/xray-mini.sh";
...
# // OpenVPN Install
wget -q -O /root/ovpn.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/ovpn.sh";
chmod +x ovpn.sh;
./ovpn.sh;

# // Wireguard Install
wget -q -O /root/wg-set.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/wg-set.sh";
chmod +x wg-set.sh;
./wg-set.sh;

# // ShadowsocksR Install
wget -q -O /root/ssr.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/setup/ssr.sh";
chmod +x ssr.sh;
./ssr.sh;

# // Installing Menu
wget -q -O /root/menu-setup.sh "https://releases.wildydev21.com/vpn-script/Stable/1.0/menu/menu-setup.sh";
